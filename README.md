...
| OpenClaw (Camina) | workspace-root `AGENTS.md`; currently points to the full machine-local agreement | target is the canonical checkout/root plus `clients/openclaw.md`; application in a new or reset session must be verified |
